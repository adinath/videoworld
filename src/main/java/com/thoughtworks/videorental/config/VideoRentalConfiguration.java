...
public class VideoRentalConfiguration {
    ...
    public MovieRepository movieRepository() {
        ...
        final Movie shamitabh = new Movie("Shamitabh", MovieType.NEW);
        final Movie sholay = new Movie("Sholay",MovieType.CLASSIC);
        return new SetBasedMovieRepository(Arrays.asList(avatar, upInTheAir, findingNemo,shamitabh,sholay));
    }
    @Bean
    @Scope(ConfigurableBeanFactory.SCOPE_SINGLETON)
